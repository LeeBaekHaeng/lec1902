...
import god.com.cmm.LoginVO;
import god.com.uat.uia.service.EgovLoginService;
 ...
 */
@Controller
public class GodLoginController {

	/** EgovLoginService */
	@Resource(name = "godLoginService")
	...
	/** log */
	private static final Logger LOGGER = LoggerFactory.getLogger(GodLoginController.class);
	 ...
	 * @exception Exception
	 */
	@IncludedInfo(name = "로그인", listUrl = "/god/uat/uia/egovLoginUsr.do", order = 10, gid = 10)
	@RequestMapping(value = "/god/uat/uia/egovLoginUsr.do")
	public String loginUsrView(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request,
		 ...
		 * gpkiresponse.getChallenge()); return "god/com/uat/uia/EgovLoginUsr";
		 * 
		 * }catch(Exception e){ return "egovframework/com/cmm/egovError"; }
		 */
		return "god/com/uat/uia/EgovLoginUsr";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/god/uat/uia/actionLogin.do")
	public String actionLogin(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request, ModelMap model)
		...
		if (resultVO != null && resultVO.getId() != null && !resultVO.getId().equals("")) {
			...
			request.getSession().setAttribute("godLoginVO", resultVO);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/god/uat/uia/actionCrtfctLogin.do")
	public String actionCrtfctLogin(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request,
		 ...
		 * "god/com/uat/uia/EgovLoginUsr"; } } else {
		 * model.addAttribute("message",
		 * egovMessageSource.getMessage("fail.common.login")); return
		 * "god/com/uat/uia/EgovLoginUsr"; }
		 */
		return "god/com/uat/uia/EgovLoginUsr";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/god/uat/uia/actionMain.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/god/uat/uia/actionLogout.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/god/uat/uia/egovIdPasswordSearch.do")
	public String idPasswordSearchView(ModelMap model) throws Exception {
		...
		return "god/com/uat/uia/EgovIdPasswordSearch";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/god/uat/uia/egovGpkiIssu.do")
	public String gpkiIssuView(ModelMap model) throws Exception {
		return "god/com/uat/uia/EgovGpkiIssu";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/god/uat/uia/searchId.do")
	public String searchId(@ModelAttribute("loginVO") LoginVO loginVO, ModelMap model) throws Exception {
		...
		if (resultVO != null && resultVO.getId() != null && !resultVO.getId().equals("")) {
			...
			return "god/com/uat/uia/EgovIdPasswordResult";
		} else {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/god/uat/uia/searchPassword.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/god/uat/uia/getEncodingData.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/god/uat/uia/EgovGpkiRegist.do")
	public String gpkiRegistView(HttpServletRequest request, HttpServletResponse response, ModelMap model)
		 ...
		 * 
		 * return "god/com/uat/uia/EgovGpkiRegist";
		 * 
		 * } catch (Exception e) { return "egovframework/com/cmm/egovError"; } }
		 * }
		 */
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/god/uat/uia/actionGpkiRegist.do")
	public String actionGpkiRegist(HttpServletRequest request, HttpServletResponse response, ModelMap model)
		 ...
		 * gpkiresponse.getChallenge());
		 * 
		 * return "god/com/uat/uia/EgovGpkiRegist"; } catch (Exception e) {
		 * return "egovframework/com/cmm/egovError"; } } }
		 */
		return "god/com/uat/uia/EgovGpkiRegist";
	}
